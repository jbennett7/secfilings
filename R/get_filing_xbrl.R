...
get_filing_xbrl <- function(cik, year, form_type, useragent) {
  ...
  inst_file <- tryCatch(
      ...
      error = function(e) {
        ...
        maybe_download(paste0(base_url, lab_name), file.path(tmp_dir, lab_name), useragent)
        ...
        maybe_download(paste0(base_url, pre_name), file.path(tmp_dir, pre_name), useragent)
        ...
        maybe_download(paste0(base_url, cal_name), file.path(tmp_dir, cal_name), useragent)
        ...
        maybe_download(paste0(base_url, def_name), file.path(tmp_dir, def_name), useragent)
