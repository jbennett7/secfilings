# inst/verify/verify_jpmorgan
# JP Morgan FY2023 10-K (CIK 19617, filed 2024-02-03)
# Known values source from SEC EDGAR interactive viewer:
#  https://www.sec.gov/ix?doc=/Archives/edgar/data/0000019617/000001961725000270/jpm-20241231.htm#fact-identifier-453

devtools::load_all(".")

UA <- "Joseph Bennett jbennett@jbennettconsulting.com"

xbrl <- get_filing_xbrl(19617, 2024, "10-K", UA)
...
known <- list(
  revenue      = list(concept = "us-gaap_InterestIncomeExpenseNet",
                      period  = "2023-12-31",
                      value   = 89267e6),
